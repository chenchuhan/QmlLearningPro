...
import QGroundControl.CCControls    1.0
...
//    property alias imageSource:     innerImage.source
    ...
    property bool    isAndroidS:       ScreenTools.isMobile
...
//    onCheckedChanged: checkable = false
    ...
    */
    ...
    property color  themeColor:                 qgcPal.ccTheme
...
//                _backgroundColor:          (checked || pressed) ? qgcPal.buttonHighlight : qgcPal.hoverColor
                ...
                _imageColor:               (checked || pressed) ? '#E1FFFF' :   themeColor
            }
            PropertyChanges {
                target: buttonBkRect
                visible: true
...
//            }
            ...
            PropertyChanges {
                target: button;
                _backgroundColor:   enabled ?   "#F0F0F0":           "#F0F0F0"
                _textColor:         enabled ?   "black" :            "black"
                _imageColor:        enabled ?   themeColor:          themeColor
            }
