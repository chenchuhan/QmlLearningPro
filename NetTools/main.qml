...
ApplicationWindow  {
    ...
    property var  globalTcpClient:          TCPClientController
    ...
    //内部使用
    property var    tcpClinet:              globalTcpClient.tcpClient
    property var    rxData:                 tcpClinet.rxData
