...
Button {
    ...
    property int _horizontalPadding:    0//ScreenTools.defaultFontPixelWidth
    property int _verticalPadding:      0//Math.round(ScreenTools.defaultFontPixelHeight * heightFactor)
    ...
    style: ButtonStyle {
            ...
            background: Rectangle {
                id:             backRect
                implicitWidth:  item.width//ScreenTools.implicitButtonWidth
