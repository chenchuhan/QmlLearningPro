...
Item {
    ...
    ///Text
    property real  hugeText:   30     //PS=PixelSize
    property real  largeText:  26
    property real  bigText:    24
    property real  mediumText: 22
    property real  smallText:  18
    property real  minText:    16

    property real  mediumImage:     28
    property real  hugeImage:       40
    ...
    readonly property real defaultWidth:    10
    readonly property real defaultHeight:   8
...
//    //start_cch_20230315
//    /* type 1: Window
//     * type 2: Android Big   Screen
//     * type 3: Android Small Screen
//     */
//    property real _screanDPI:                       ScreenToolsController.screanDPI
//    property int type:                              isAndroid ? (_screanDPI<300 ? 2 : _screanDPI<=317 ? 3 : 4 ) : 1
...
//    property real testDensity :                      (Screen.width / realPixelDensity)
...
//    //start_cch_20210723 +1-1
//    property real implicitComboBoxWidth:            Math.round(defaultFontPixelWidth *  (isMobile ? 3.0 : 5.0))
...
//    //2022-06-14 hht add
//    property real pixelRatio:                       ScreenToolsController.pixelRatio
//    property real fontPixel:                        ScreenToolsController.fontPixel
//    readonly property real imagePixelNor:           ScreenToolsController.fontPixel * 13
//    //start_cch_20220811 +4
//    property real  hugePixelSize:          30 * pixelRatio
//    property real  largePixelSize:         26 * pixelRatio
//    property real  bigPixelSize:           24 * pixelRatio
//    property real  mediumPixelSize:        22 * pixelRatio  //
//    property real  smallPixelSize:         18 * pixelRatio  //18  16对于Android小了
//    property real  minPixelSize:           16 * pixelRatio  //18  16对于Android小了
//    property real  mediumImage:            28 * pixelRatio  //30大了  25稍小了
//    property real  hugeImage:              40 * pixelRatio  //30大了  25稍小了
//    property real  marginSize:             4 * pixelRatio
...
//        }
//        //start_cch_20210721
//        toolbarHeight           = isMobile ? minTouchPixels : defaultFontPixelHeight * 4//3
